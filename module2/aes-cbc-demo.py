...
# Demonstration: En ændring i CBC mode påvirker flere blokke
print("\n" + "="*60)
print("DEMONSTRATION: ÆNDRING I CBC MODE")
print("="*60)

# Statisk 128-bit (16 byte) nøgle
key = b"0123456789abcdef"  # 16 bytes

# Statisk 128-bit (16 byte) IV (Initialization Vector)
...
# Ændret plaintext - blok 1 ændres (Secret -> Public)
plaintext = b"Public message: meet me here at the data center!"
